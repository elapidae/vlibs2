...
#========================================================================================
message( STATUS "about include vposix..." )
...
set( V_HEADERS ${V_HEADERS} "${VLIBS_DIR}/vposix/impl_vposix/wrap_net_if.h"   )
set( V_SOURCES ${V_SOURCES} "${VLIBS_DIR}/vposix/impl_vposix/wrap_net_if.cpp" )

...
isEmpty(qi_vnetwork) {
    ...
    HEADERS     += $$VLIBS_DIR/vnetwork/vinet_address.h
    SOURCES     += $$VLIBS_DIR/vnetwork/vinet_address.cpp
...
#    HEADERS     += $$VLIBS_DIR/vnetwork/impl_vnetwork/poll_context.h
#    SOURCES     += $$VLIBS_DIR/vnetwork/impl_vnetwork/poll_context.cpp

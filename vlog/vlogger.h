 ...
 *
 *  UPD 2019-09-26  by elapidae
 *  Добавлена фича [bool] как отключатель логгирования.
*/
//=======================================================================================
...
//=======================================================================================
class VLogger final : public impl::vcat_iface<VLogger>
{
public:
    //-----------------------------------------------------------------------------------
...
private:
    ...
    friend class VError;
    friend class impl::vcat_iface<VLogger>;
